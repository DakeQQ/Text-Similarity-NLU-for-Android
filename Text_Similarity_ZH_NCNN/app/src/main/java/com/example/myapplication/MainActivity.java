...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Load_Models_0(mgr,false,false,false)) { // The GPU failed for the GTE-NCNN; it appears to be an issue with the FP16 computing.
    ...
    private static native boolean Load_Models_0(AssetManager assetManager, boolean USE_INT8, boolean USE_FP16, boolean USE_GPU);
