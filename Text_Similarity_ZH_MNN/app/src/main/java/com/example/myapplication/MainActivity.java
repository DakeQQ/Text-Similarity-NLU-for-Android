...
public class MainActivity extends AppCompatActivity {
    ...
    static {
        System.loadLibrary("common_1_0");  // For OpenCL backend
        System.loadLibrary("common_1_1");  // For OpenCL backend
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Load_Models_0(mgr,true,false,false,false,false,false)) {
    ...
    private native boolean Load_Models_0(AssetManager assetManager, boolean USE_INT8, boolean USE_FP16, boolean USE_BF16, boolean USE_GPU, boolean USE_NNAPI, boolean CONVERT_FROM_TF);
